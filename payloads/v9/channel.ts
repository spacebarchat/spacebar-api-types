...
import type { APIInvite } from './invite';
...
export enum ChannelType {
	...
	EncryptedThread,
	/**
	 * Event chain style transactional channel
	 */
	Transactional,
	/**
	...
	GuildForum,
	/**
	 * ticket tracker, individual ticket items shall have type 12
	 */
	TicketTracker = 33,
	/**
	 * Confluence like kanban board
	 */
	KanBan = 34,
	/**
	 * Whiteboard but without voice (whiteboard + voice is the same as stage)
	 */
